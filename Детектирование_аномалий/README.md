...
Выявление аномалий с точки зрения кластеризации субъективно и может трактоваться по разному, хотя аномалий вызванных рекламой явно нет. Так что существующая разность средних вызвана скорее иными, чем реклама в популярной передаче.  
# 3.Датасет
tea_demand.zip
Размер: 2КБ
